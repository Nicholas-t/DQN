...
class Game:
    def __init__( self, mode='human',  lives=3):
        ...
        self.BALL_INITIAL_POSITION_Y = 330
    ...
    def step_frame(self, action):
        ...
        meta_font = pygame.font.Font(None, 17)
        text = meta_font.render("Pad : {}, {}".format(self.paddle.rect.x, self.paddle.rect.y), 5, self.WHITE)
        self.screen.blit(text, (200,10))
        text = meta_font.render("Ball v : {}, {}".format(self.ball.velocity[0], self.ball.velocity[1]), 1, self.WHITE)
        self.screen.blit(text, (300,10))
        text = meta_font.render("Ball : {}, {}".format(self.ball.rect.x, self.ball.rect.y), 1, self.WHITE)
