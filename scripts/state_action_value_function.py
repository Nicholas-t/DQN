...
def createEpsilonGreedyPolicy(Q: list, epsilon: float, num_actions: int) -> list:
...
def qLearning(
    ...
    for ith_episode in range(num_episodes):
        ...
        while True:
            ...
            td_target = (
                reward
                + discount_factor * Q[convert_state(next_state)][best_next_action]
            )
...
def plot_q(
    ...
    title: str = "Epsilon Greedy policy",
):
